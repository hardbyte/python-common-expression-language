...
class TestPythonExceptionPropagation:
    ...
    def test_type_error_propagation(self):
        ...
        with pytest.raises(RuntimeError, match="Arguments must be numeric"):
            cel.evaluate("math('hello', 'world')", {"math": strict_math, "str1": "hello", "str2": "world"})
    ...
    def test_custom_exception_propagation(self):
        ...
        # Should work normally
        assert cel.evaluate("validate('test@example.com')", {"validate": validate_email}) == "test@example.com"
...
class TestFunctionSignatures:
    ...
    def test_no_arguments_function(self):
        ...
        assert cel.evaluate("current_time()", {"current_time": get_current_time}) == "2024-01-01T00:00:00Z"
    ...
    def test_keyword_arguments_simulation(self):
        ...
        title_context = {"format": format_person, "person": {"name": "Bob", "age": 45, "title": "Dr."}}
...
class TestComplexTypeHandling:
    ...
    def test_dict_input_and_output(self):
        ...
        # Test key extraction
        keys_context = {"get_keys": extract_keys, "data": {"name": "Alice", "age": 30, "city": "NYC"}}
...
class TestFunctionPerformance:
    ...
    def test_complex_function_call_performance(self):
        ...
        assert avg_time < 0.001, f"Complex function call too slow: {avg_time*1000:.1f} ms per call"
    ...
    def test_function_call_with_large_data(self):
        ...
        assert execution_time < 0.01, f"Large data processing too slow: {execution_time*1000:.1f} ms"
...
class TestFunctionIntegrationWithCELFeatures:
    ...
    def test_function_with_list_operations(self):
        ...
        assert cel.evaluate("even(4)", context) == True
        assert cel.evaluate("even(3)", context) == False
    ...
    def test_function_with_map_operations(self):
        ...
        assert cel.evaluate("has_prop(user, 'profile')", context) == True
        assert cel.evaluate("has_prop(user, 'missing')", context) == False
