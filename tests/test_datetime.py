...
class TestDatetimeBasics:
    ...
    def test_datetime_with_different_timezones(self):
        ...
        result = evaluate("dt", {"dt": utc_time})
        ...
        result = evaluate("dt", {"dt": offset_time})
        ...
        result = evaluate("dt", {"dt": negative_offset_time})
    ...
    def test_naive_datetime_conversion(self):
        ...
        result = evaluate("dt", {"dt": naive_time})
    ...
    def test_datetime_microseconds(self):
        ...
        result = evaluate("dt", {"dt": dt_with_microseconds})
...
class TestDatetimeArithmetic:
    ...
    def test_datetime_arithmetic(self):
        ...
        result = evaluate("dt + duration", {"dt": base_time, "duration": one_hour})
    ...
    def test_datetime_arithmetic_edge_cases(self):
        ...
        result = evaluate("dt + delta", {"dt": base_dt, "delta": zero_delta})
    ...
    def test_nested_datetime_operations(self):
        ...
        result = evaluate("(dt1 + delta) == dt2", context)
        assert result is True

        # Nested comparison
        result = evaluate("dt1 < dt2 && (dt1 + delta) == dt2", context)
        assert result is True
...
class TestDatetimeComparisons:
    ...
    def test_datetime_comparisons(self):
        ...
        # dt1 < dt2
        result = evaluate("dt1 < dt2", {"dt1": dt1, "dt2": dt2})
        assert result is True

        # dt1 == dt1
        result = evaluate("dt1 == dt1", {"dt1": dt1})
        assert result is True

        # dt2 > dt1
        result = evaluate("dt2 > dt1", {"dt1": dt1, "dt2": dt2})
        assert result is True
    ...
    def test_timezone_awareness_mixed(self):
        ...
        result_utc = evaluate("utc_dt", context)
        assert result_utc == utc_time

        result_naive = evaluate("naive_dt", context)
...
class TestDatetimeEdgeCases:
    ...
    def test_datetime_with_extreme_microseconds(self):
        ...
        result = evaluate("dt", {"dt": extreme_dt})
    ...
    def test_ambiguous_local_datetime(self):
        ...
        result = evaluate("dt", {"dt": naive_dt})
        assert isinstance(result, datetime.datetime)
        assert result.tzinfo is not None
    ...
    def test_dst_transition_dates(self):
        ...
        result = evaluate("dt", {"dt": spring_forward})
        ...
        result = evaluate("dt", {"dt": fall_back})
