...
class TestIssue16StringLiteralRegression:
    ...
    def test_escaped_quotes_in_strings(self):
        ...
        assert result == 'He said "hello123"', f"Escaped quotes should be handled correctly"
        
        # Test escaped single quotes
        result = evaluate("'Don\\'t change123'", ctx)
        assert result == "Don't change123", f"Escaped single quotes should be handled correctly"
